"""
OR-Tools Example: simple_min_cost_flow_program.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/graph/samples/simple_min_cost_flow_program.py
