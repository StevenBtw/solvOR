"""
OR-Tools Example: interval_relations_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/interval_relations_sample_sat.py
