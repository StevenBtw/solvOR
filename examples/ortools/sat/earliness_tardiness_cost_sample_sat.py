"""
OR-Tools Example: earliness_tardiness_cost_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/earliness_tardiness_cost_sample_sat.py
