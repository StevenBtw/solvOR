"""
OR-Tools Example: sequences_in_no_overlap_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/sequences_in_no_overlap_sample_sat.py
