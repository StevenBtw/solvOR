"""
OR-Tools Example: all_different_except_zero_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/all_different_except_zero_sample_sat.py
