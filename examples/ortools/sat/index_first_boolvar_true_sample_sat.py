"""
OR-Tools Example: index_first_boolvar_true_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/index_first_boolvar_true_sample_sat.py
