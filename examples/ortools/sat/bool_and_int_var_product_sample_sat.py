"""
OR-Tools Example: bool_and_int_var_product_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/bool_and_int_var_product_sample_sat.py
