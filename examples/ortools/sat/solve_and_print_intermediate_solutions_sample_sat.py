"""
OR-Tools Example: solve_and_print_intermediate_solutions_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/solve_and_print_intermediate_solutions_sample_sat.py
