"""
OR-Tools Example: overlapping_intervals_sample_sat.py

This is a solvOR implementation of the Google OR-Tools example.
Original: https://github.com/google/or-tools/blob/stable/ortools/sat/samples/overlapping_intervals_sample_sat.py
